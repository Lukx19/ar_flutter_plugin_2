...
class M0aTransportInstrumentation {
    ...
    data class ResourceLimits(
        ...
        val maxStructuralTransactionBytes: Int = M0aStructuralTransactionLimits.MAX_STRUCTURAL_TRANSACTION_BYTES,
        val diagnosticSummaryBytes: Int = 1024,
        val diagnosticSummaryRateHz: Int = 5,
        val structuralTransactionFrames: Int = M0aStructuralTransactionLimits.frameCount(
            M0aStructuralTransactionLimits.MAX_STRUCTURAL_TRANSACTION_BYTES,
            M0aPacketCodec.responseMaximumBytes,
        ),
        val structuralChunkBytes: Int = M0aStructuralTransactionLimits.ordinaryChunkPayloadBytes,
        val catchUpStructuralTransactionFrames: Int = M0aStructuralTransactionLimits.frameCount(
            M0aStructuralTransactionLimits.MAX_STRUCTURAL_TRANSACTION_BYTES,
            M0aPacketCodec.catchUpMaximumBytes,
        ),
        val catchUpStructuralChunkBytes: Int = M0aStructuralTransactionLimits.catchUpChunkPayloadBytes,
