...
/** Canonical reasons carried by the visibility protocol kind-4/version-1 resync command. */
enum class ResyncReason(val id: Int) {
...
data class ResyncPayloadV1(
    ...
    companion object {
        ...
        fun decode(bytes: ByteArray): ResyncPayloadV1 {
            ...
            return ResyncPayloadV1(
                ...
                reason = ResyncReason.fromId(data.getShort(32).toInt() and 0xffff),
...
data class ResyncCommandV1(val payload: ResyncPayloadV1) {
    fun encode(): ByteArray = ByteArray(BYTE_LENGTH).also { bytes ->
        bytes[0] = KIND.toByte()
