...
object StartResultCodecV2 {
    ...
    fun encode(
        ...
        data.putShort(0, StartRequestCodecV2.supportedMinor.toShort())
        ...
        data.putInt(24, configuration.negotiatedModelCapacity)
        ...
        val revisions = if (baseline != CommittedBaselineV1.ZERO) {
