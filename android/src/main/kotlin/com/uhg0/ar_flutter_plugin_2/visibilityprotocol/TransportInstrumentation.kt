...
/**
 * Bounded, numeric telemetry for one packed visibility protocol binding.
 *
...
class TransportInstrumentation {
    /** Fixed visibility protocol budgets; these are configuration observables, not pass claims. */
    ...
    data class ResourceLimits(
        ...
        val maxStructuralTransactionBytes: Int = StructuralTransactionLimits.MAX_STRUCTURAL_TRANSACTION_BYTES,
        val diagnosticSummaryBytes: Int = 1024,
        val diagnosticSummaryRateHz: Int = 5,
        val structuralTransactionFrames: Int = StructuralTransactionLimits.frameCount(
            StructuralTransactionLimits.MAX_STRUCTURAL_TRANSACTION_BYTES,
            PacketCodec.responseMaximumBytes,
        ),
        val structuralChunkBytes: Int = StructuralTransactionLimits.ordinaryChunkPayloadBytes,
        val catchUpStructuralTransactionFrames: Int = StructuralTransactionLimits.frameCount(
            StructuralTransactionLimits.MAX_STRUCTURAL_TRANSACTION_BYTES,
            PacketCodec.catchUpMaximumBytes,
        ),
        val catchUpStructuralChunkBytes: Int = StructuralTransactionLimits.catchUpChunkPayloadBytes,
